...
export const REVIEWS = [
    {
        photo: <StaticImage className='photo' src='../images/gosia.jpg' alt='Zdjęcie Małgorzaty Lorenc'/>,
    ...
    },
    {
      ...
      text: 'Psi hotel Kanie, to miejsce gdzie psy mogą poczuć domową atmosferę, czułość, troskę i wygodę. Dom - hotelik ma duży ogród, położony jest w pięknej, zielonej okolicy. Psy mieszkają w pokojach, niektóre nawet śpią z gospodarzami:-) Dziękujemy za gościnę!'
    }, 
    {
      photo: <StaticImage className='photo' src='../images/avatar.png' alt='Avatar opiniującego bez zdjęcia'/>,
      name: 'Dagmara Wróbel',
      text: 'W tym miejscu dzieją się cuda! Pozytywna domowa atmosfera, uważność na zalecenia zdrowotne, gry, zabawy i pieszczoty do woli, towarzystwo psich kompanów i ludzkich opiekunów wedle preferencji i ogarniający wszystko spokój. Zdecydowanie polecam psi hotel Kanie jeśli potrzebujesz oddać swojego psa na dłuższą lub krótszą chwilę w dobre ręce. Na pewno wróci zrelaksowany i zadowolony!'
    },
    {
      photo: <StaticImage className='photo' src='../images/Magdalena_Winska.png' alt='Zdjęcie Magdaleny Wińskiej'/>,
      name: 'Magdalena Wińska',
      text: "Super miejsce, przyjazne wszystkim psiakom. Hotelik prowadzą doświadczone osoby w opiece nad zwierzętami, które wiedzą co robią i doskonale znają psi język :) ogromnym plusem jest duży ogród, w którym mój piesek mógł swobodnie się wybiegać 😍i do tego domowe warunki, kanapy, legowiska, polecam!!!"
    },
    {
      photo: <StaticImage className='photo' src='../images/avatar.png' alt='Avatar opiniującego bez zdjęcia'/>,
      name: 'Joanna Rozanska',
      text: "Psi hotel Kanie to miejsce magiczne,wyjątkowe.Pracują w nim ludzie tak niesamowicie oddani zwierzętom,rozumiejący ich potrzeby i przepełnieni milością do nich.Moje sunie przebywały w hoteliku 10 dni, były poraz pierwszy beze mnie i oczywiście bałam się jak to zniosą.Okazało się,że super.Pan Bartek przesyłał mi codziennie zdjęcia co było bardzo miłe i uspokajające.Zwierzęta w hoteliku czują się jak u siebie,są zaopiekowane i kochane. Dziękuję panu Bartkowi i Sylwii za opiekę nad Tildą i Helą. Polecam z całego serca to miejsce,ja na pewno będę korzystać."
    },
    {
      photo: <StaticImage className='photo' src='../images/Malgorzata_Palys.png' alt='Zdjęcie Małgorzaty Pałys'/>,
